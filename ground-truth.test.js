...
test("ground truth values for default preset (Hinged Counterweight)", () => {
  ...
  // Normalize constraints (fill in missing types and convert duplicate sliders to pins)
  normalizeConstraints(data);
  ...
  // Calculate peakLoad and range using shared utility functions
